...
public class OpenCvRaspberryPiCamera implements CubeColorInspector{
    ...
    public char[][][] inspect() throws InterruptedException {
        ...
        //TODO capture an image with captureImage()
        captureImage();

        startDrawing();//draws and writes helpful info in the image file for tuning purposes
        drawTuningGrid(200);//draws helpful tuning grid for rectangle coordinates
    ...
    public char[][] inspectBackFace(char center) {
        ...
        //TODO set piece to 0
        piece = 0;
        //TODO set color to the face index that matches the center
        ...
        return new char[][]{//returns a 2 dimensional array of the colors of the back face
                ...
                {
                        findColor(730+offsetX,1725+offsetY,120,125),
        ...
        return new char[][]{
                {
                        ...
                        findColor(2620+offsetX,720+offsetY,70,50),
                },
                {
                ...
                },
                {
                        ...
                        findColor(2815+offsetX,1580+offsetY,100,300)
                },
        };
    }
        ...
        return new char[][]{
                {
                        ...
                        findColor(1940+offsetX,2265+offsetY,70,25),
                },
                {
    ...
    public static char classifyColor(Mat square) {
        ...
        char medianLabColor = classifyColorDeltaELab(medianL, medianB, medianA);//TODO figure out what color the square is given the median lab values using the function you code that does it
    ...
    public static char classifyColorDeltaELab(int l, int a, int b){
        ...
        for(Map.Entry<Character, int[]> entry : referenceColors.entrySet()){//goes through all reference colors
            ...
            double deltaE = Math.sqrt(Math.pow(l - ref[0]/*TODO add the l value of the reference value*/, 2)/5 + Math.pow(a -ref[1] /*TODO add the a value of the reference value*/, 2) + Math.pow(b - /*TODO add the b value of the reference value*/, 2));//uses the pythagorean theorem to calculate the distance of the actual color to the reference color
